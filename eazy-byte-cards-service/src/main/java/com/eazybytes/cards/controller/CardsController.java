...
public class CardsController {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestParam
                                                               @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                               String mobileNumber,
                                                     @RequestHeader(CardsConstants.CORRELATION_DEFAULT) String correlationId) {
    ...
    public ResponseEntity<String> getBuildInfo() {
        return ResponseEntity.status(HttpStatus.OK).body(env.getProperty("build.version"));
    }
    ...
    public ResponseEntity<ContactInfoDTO> getContactDetails() {
